    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex">
            ...
            <div class="ml-12 mr-64">
                ...
                <p class="mt-12">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero, velit! Vel nemo error esse nulla
                    officiis libero ullam nesciunt fuga labore quo! Cum rem quam ut cupiditate atque error cumque?
                </p>
        ...
        <div class="images-container mt-8">
            ...
            <div class="popular-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
                <div class="game mt-6">
                    ...
                    <a href="#" class="block text-base font-semibold leading-tight hover:text-gray-400 mt-8">Duck Nuckem
                        3D</a>
